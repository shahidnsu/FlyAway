...
const creatingMailOptions = function(email,id) {
  ...
  <h1 style="text-align: center; font-weight: 100; font-size: 20px ; line-height: 57px;  font-family: Verdana; margin: 0px;">Thank you  for Booking trip with flyAway    ${id}</h1>
